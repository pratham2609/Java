...
public class NinjaTraining {
    public int calculatePoints(int points[][], int N, int day, int last, int[][] dp) {
        // check if there's value in dp
        ...
        for(int task = 0; task < 3; task++) {
            if(task != last) {
                int point = points[day][task] + calculatePoints(points, N, day - 1, task, dp);
